...
# get ref df
df_ref = lst.create_deflector(f'/home/lyumx/work/lens-data/{cluster_name}/origin_data/best.par',
...
ax[1].imshow(df_ref.ka,origin='lower',vmax = 3,vmin=0,extent=fov)
# critical curve
tl = df_ref.tancl()
...
ax[1].set_title('origin critical and cautics',fontsize=30)
